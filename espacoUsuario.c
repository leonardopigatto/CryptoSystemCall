...
int main()
{
	...
	void *buf;
	char caminho[100];//= "/home/puc/Documentos/valorCrp\0";
	char nomeArquivo[20];
	int tamanho, tInicial, fd, i, hexa1, hexa2, len;
	...
	printf("Digite o local onde sera salvo arquivo (exemplo: /home/puc/Documentos/):\n");
	__fpurge(stdin);
	scanf("%[^\n]%*c", caminho);
